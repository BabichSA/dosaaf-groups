...
class DrivingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create driving" do
    assert_difference('Driving.count') do
      post drivings_url, params: { driving: { instructor_id: @driving.instructor_id, start_date: @driving.start_date, student_id: @driving.student_id } }
    end
  ...
  test "should update driving" do
    patch driving_url(@driving), params: { driving: { instructor_id: @driving.instructor_id, start_date: @driving.start_date, student_id: @driving.student_id } }
